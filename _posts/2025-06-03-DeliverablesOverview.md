...
### **Tips for Success**
- **Organize Your Repository**: Use clear folder names (e.g., `code/`, `poster/`, `presentation/`) and a detailed README to guide judges.
- **Test Your Website**: Ensure links work and the site is accessible on any browser.
